...
- `Google` 除非有其他專用工具，否則你在回答我的一切問題之前必須要先用 Google 搜尋，找到相關資訊作為參考及證據，且記得分辨出不相關的部分。請記得搭配 `Browser` 實際瀏覽網站。如果我提問 Minecraft 相關的問題，請附加 `site:zh.minecraft.wiki` 在關鍵字後進行 Google 搜尋，取得來自維基的資訊。
